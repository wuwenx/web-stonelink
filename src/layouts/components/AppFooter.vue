                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="relative">
                            <button @click="showLanguageMenu = !showLanguageMenu"
                                class="flex items-center text-sm text-gray-500 hover:text-gray-900 transition-colors">
                            ...
                            <div v-show="showLanguageMenu"
                                class="origin-bottom-right absolute bottom-full right-0 mb-2 w-32 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-50">
                                <div class="py-1">
                ...
                <div class="mt-4 pt-4 border-t border-gray-200">
                    <div class="flex flex-col md:flex-row justify-between items-center text-xs text-gray-500">
                        <div class="mb-2 md:mb-0">
                            版本: {{ appStore.systemInfo.version }} |
                            构建时间: {{ formatDate(appStore.systemInfo.buildTime) }}
                        </div>
                        <div class="flex items-center space-x-4">
